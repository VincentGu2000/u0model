...
# from .detect_head.target_head import TargetHead,TargetHeadConfig
...
class GR00T_N1_5(PreTrainedModel):
    ...
    def __init__(
        ...
        # target_head_cfg = TargetHeadConfig(**config.target_head_cfg)
        ...
        # )
        # self.sersonr_encoder = nn.Sequential(
        #     nn.LayerNorm(vit_hidden_size * int(1 / self.downsample_ratio) ** 2),
        #     nn.Linear(vit_hidden_size * int(1 / self.downsample_ratio) ** 2, llm_hidden_size),
        #     nn.GELU(),
        #     nn.Linear(llm_hidden_size, llm_hidden_size)
    ...
    def forward(
        ...
        # target_head_outputs = self.target_head(backbone_outputs, action_inputs)
